...
bool compare_Core_handles(lhs, rhs) {
...
int main() {
	...
	//ㄴ> compare_Core_ptrs 대신에 compare하면 이름으로 정렬, compare_grades하면 성적 정렬
	//ㄴ> 근데 core.h랑 core.cpp에서 함수원형에서 참조를 포인터로 바꿔야됨
